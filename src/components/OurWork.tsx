    ...
    return (
        <section className="pt-[30px] pb-[30px] px-[5%] md:px-[10%] max-md:px-4 w-full box-border flex justify-center">
            <div className="relative w-full rounded-[24px] md:rounded-[32px] bg-white/5 border border-white/10 backdrop-blur-[20px] p-4 md:p-6 text-center overflow-hidden shadow-2xl">
                ...
                {/* Heading */}
                <h2 className="text-3xl md:text-7xl font-serif text-white mb-4 leading-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left border-t border-white/10 pt-6">
                    ...
                    <div className="row-span-1 md:row-span-2 relative group overflow-hidden rounded-[20px] md:rounded-[24px] bg-white/5 border border-white/10 p-5 md:p-6 max-md:p-3 flex flex-col justify-end min-h-[140px] md:min-h-[600px] transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                        {/* Background Image */}
                        <div className="absolute inset-0 z-0 opacity-50 mix-blend-overlay transition-opacity duration-300 group-hover:opacity-70">
                            <Image src={cardImg1} alt="Instant Talk" fill className="max-md:object-contain object-cover" />
                        </div>
                    ...
                    <div className="relative group overflow-hidden rounded-[20px] md:rounded-[24px] bg-white/5 border border-white/10 p-5 md:p-6 max-md:p-3 flex flex-col justify-end min-h-[140px] md:min-h-[350px] transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                        {/* Background Image */}
                        <div className="absolute inset-0 z-0 opacity-40 mix-blend-overlay transition-opacity duration-300 group-hover:opacity-60">
                            <Image src={cardImg2} alt="Fine Details" fill className="max-md:object-contain object-cover" />
                        </div>
                    ...
                    <div className="relative group overflow-hidden rounded-[20px] md:rounded-[24px] bg-white/5 border border-white/10 p-5 md:p-6 max-md:p-3 flex flex-col justify-end min-h-[140px] md:min-h-[350px] transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                        {/* Background Image */}
                        <div className="absolute inset-0 z-0 opacity-40 mix-blend-overlay transition-opacity duration-300 group-hover:opacity-60">
                            <Image src={cardImg3} alt="Encrypted Approach" fill className="max-md:object-contain object-cover" />
                        </div>
                    ...
                    <div className="md:col-span-2 relative group overflow-hidden rounded-[20px] md:rounded-[24px] bg-blue-800 border border-blue-800 p-5 md:p-6 max-md:p-3 flex items-center justify-between min-h-[120px] md:min-h-[250px] transition-all duration-300 hover:bg-blue-700">
                        ...
                        <div className="flex flex-col gap-2 z-10">
                            <h3 className="text-3xl md:text-4xl font-serif text-white leading-tight max-md:text-xl">Explore<br />Features</h3>
                        </div>
