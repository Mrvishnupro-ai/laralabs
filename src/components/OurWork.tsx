...
const OurWork = () => {
    return (
        <section className="py-[60px] px-[10%] w-full box-border flex justify-center">
            <div className="relative w-full rounded-[32px] bg-white/5 border border-white/10 backdrop-blur-[20px] p-10 md:p-20 text-center overflow-hidden shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left border-t border-white/10 pt-12">
                    ...
                    <div className="row-span-1 md:row-span-2 relative group overflow-hidden rounded-[24px] bg-white/5 border border-white/10 p-8 flex flex-col justify-end min-h-[400px] transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                        {/* Background Image */}
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-3xl font-serif text-white mb-2">Automations & Marketing Operations</h3>
                            <p className="text-gray-400 font-sans text-sm mb-4">Reduce manual work in marketing & operations</p>

                        </div>
                    </div>

                    {/* Square Card - Fine Details */}
                    <div className="relative group overflow-hidden rounded-[24px] bg-white/5 border border-white/10 p-8 flex flex-col justify-end min-h-[300px] transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                        {/* Background Image */}
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-3xl font-serif text-white mb-2">AI Creatives</h3>
                            <p className="text-gray-400 font-sans text-sm">Create content, designs, and ideas faster</p>
                        </div>
                    </div>
                    ...
                    <div className="relative group overflow-hidden rounded-[24px] bg-white/5 border border-white/10 p-8 flex flex-col justify-end min-h-[300px] transition-all duration-300 hover:bg-white/10 hover:scale-[1.02]">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl font-serif text-white mb-2">Customised AI Agents</h3>
                            <p className="text-gray-400 font-sans text-sm">Build AI agents trained on your data</p>

                        </div>
                    </div>

                    {/* Wide Card - Explore Features */}
                    <div className="md:col-span-2 relative group overflow-hidden rounded-[24px] bg-blue-600 border border-blue-500 p-8 flex items-center justify-between min-h-[200px] transition-all duration-300 hover:bg-blue-500">
                        {/* Background Image */}
