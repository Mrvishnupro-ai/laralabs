...
const Footer = () => {
    ...
    return (
        <footer className="relative w-full bg-[#050505]/60 backdrop-blur-sm pt-24 overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative z-10 w-full px-[5%]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-24 mb-20">
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        <div className="mt-2">
                            <h3 className="text-5xl md:text-6xl font-semibold text-white leading-[1.1]">
                        ...
                        <div className="mt-4">
                            <Link 
                                href="/contact" 
                                className="inline-flex h-14 items-center justify-center rounded-full bg-white px-10 text-lg font-bold text-black transition-transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
                            >
                                Get Started
                            </Link>
                        </div>
                    ...
                    <div className="lg:col-span-3 pt-2 lg:pl-12">
                        ...
                        <ul className="space-y-6">
                            {footerLinks.map((item) => (
                                <li key={item.name}>
                                    <Link href={item.href} className="text-zinc-500 hover:text-blue-400 transition-colors text-lg font-medium">
                                        {item.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-10 pt-2">
                        <div>
                            <h4 className="text-white font-semibold mb-6 text-xl">Join our developers community</h4>
                            <div className="flex gap-2 w-full">
                                <input 
                                    type="email" 
                                    placeholder="Enter your email" 
                                    className="flex-1 h-14 rounded-xl bg-white/5 border border-white/10 px-6 text-white placeholder:text-zinc-600 focus:outline-none focus:border-blue-500 focus:bg-white/10 transition-all min-w-0"
                                />
                                <button className="h-14 px-8 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold transition-all shadow-[0_0_15px_rgba(37,99,235,0.4)] whitespace-nowrap">
                                    Join
                                </button>
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex gap-4 mb-8">
                                {socialLinks.map((social) => (
                                    <Link 
                                        ...
                                        href={social.href} 
                                        target="_blank"
                                        className="w-14 h-14 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-zinc-400 hover:bg-white hover:text-blue-600 hover:border-white transition-all duration-300 group"
                                    >
                            ...
                            <div className="text-zinc-400">
                                ...
                                <p className="text-white hover:text-blue-400 transition-colors cursor-pointer text-lg font-medium">hello@laralabs.ai</p>
                            </div>
                        </div>
                    </div>
                </div>
