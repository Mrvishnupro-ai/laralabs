...
export default function Hero() {
    return (
        <section className="relative pt-40 md:pt-32 pb-[30px] px-[5%] md:px-[10%] min-h-[auto] md:min-h-screen flex flex-col items-center text-center justify-center overflow-hidden">
            ...
            <div className="badge-wrapper relative z-10">
                ...
                <Image src={pillImage} alt="Success As A Service" className="h-6 md:h-12 w-auto object-contain hover:scale-105 transition-transform duration-300 cursor-pointer" />
            ...
            <div className="flex items-center gap-4 mb-8 z-10">
                <button suppressHydrationWarning className="bg-white text-black px-6 py-2 md:px-8 md:py-3 text-sm md:text-base rounded-full font-medium hover:bg-gray-200 transition-colors">
                    Request a demo
                </button>
                <Link href="/coming-soon">
                    <button suppressHydrationWarning className="bg-white/10 text-white border border-white/10 px-6 py-2 md:px-8 md:py-3 text-sm md:text-base rounded-full font-medium hover:bg-white/20 transition-colors backdrop-blur-md">
                        Learn More
                    </button>
                </Link>
            </div>
